package com.wenxin2.dt_inventorypets;
...
@Mod(DynamicTreesInventoryPets.MOD_ID)
public final class DynamicTreesInventoryPets {

    public static final String MOD_ID = "dt_inventorypets";

    public DynamicTreesInventoryPets() {
